...
import javax.swing.*;
/*
 * Created by JFormDesigner on Tue Dec 13 20:02:31 CST 2022
 */
 ...
 * @author Brainrain
 */
public class GUI_TeaJudgeDel extends JDialog {
    Connection con;
    Statement statement;
    PreparedStatement preparedstatement;
    ResultSet resultset;
    public GUI_TeaJudgeDel(Window owner) {
        super(owner);
    ...
    private void button1(ActionEvent e) {
        ...
        if(GUI_TeaJudge.data.size()==0){
            JOptionPane.showMessageDialog(null,"该判断题题库为空,请勿删除!","警告",JOptionPane.ERROR_MESSAGE);
            textField1.setText("");
        }
        else {
                ...
                for (int i = 0; i < GUI_TeaJudge.data.size(); i++) {
                    ...
                    if(Main.isNumeric(temp)&&Integer.valueOf(temp)==GUI_TeaJudge.data.get(i).getId()) {
                        ...
                        try{
                            ...
                            String sql = "delete from 判断题 where id=?";
                        ...
                        JOptionPane.showMessageDialog(null, "删除成功!", "判断题删除记录", JOptionPane.PLAIN_MESSAGE);
                    }
                }
